...
1. **Suivi des performances du portefeuille :**
   - Implémentation d'indicateur clés de performance : Moyenne des rendemments annualisé, ratio de Sharpe, ration d'information (IR).
   - Performance sur une période de 20 ans.

3. **Analyse des risques :**
   - Implémentation d'indicateur clés de risque : Volatilité annualisé, VaR, TrackingError (TE).
...
6. **Base de données :**
   - Importation de fichier CSV créer à partir de Python
...
- **Résultats attendus :**
  - Deux bases fonctionnelle contenant les actions et du portefeuille et un benchmark.

### 2. Outil de d'Analyse  (*fichier 2*)
- **Caractéristiques :**
